...
const Profile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    specialties: 'Droit du travail, Droit immobilier, Droit de la consommation',
    experience: '15 ans d\'expérience en droit du travail et droit immobilier. Ancien juriste d\'entreprise, maintenant avocat indépendant spécialisé dans les litiges entre particuliers et professionnels.',
    baseRate: '150',
    currentPassword: '',
    newPassword: '',
    confirmPassword: ''
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">Avocat</p>
              </div>
            ...
            <div className="border-t pt-4">
              <h3 className="text-lg font-medium mb-3">Expérience</h3>
              <p className="text-gray-700">{formData.experience}</p>
            </div>
            
            <div className="border-t pt-4">
              <h3 className="text-lg font-medium mb-3">Tarif horaire de base</h3>
              <p className="text-xl font-bold text-primary-600">{formData.baseRate}€ / heure</p>
            </div>
          </div>
        )}
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center">
            <input
              ...
              defaultChecked
            />
            <label htmlFor="requestNotifications" className="ml-2">
              Notifications de nouvelles demandes juridiques
            </label>
          </div>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="proposalNotifications" className="ml-2">
              Notifications de propositions acceptées
            </label>
          </div>
