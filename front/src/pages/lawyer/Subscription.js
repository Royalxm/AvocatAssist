    ...
    <div className="space-y-6">
      ...
      {currentPlan && (
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mt-6">
            <h3 className="text-lg font-medium mb-3">Avantages de votre plan</h3>
            <ul className="space-y-2">
              {plans.find(plan => plan.id === currentPlan.id)?.features.map((feature, index) => (
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-xl font-semibold mb-4">Avantages pour les avocats</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-4 border border-gray-200 rounded-lg">
            <div className="text-3xl text-primary-600 mb-2">🔍</div>
            <h3 className="text-lg font-medium mb-2">Visibilité accrue</h3>
            <p className="text-gray-600">
              Les plans payants vous permettent d'être mieux positionné dans les résultats de recherche des clients.
            </p>
          </div>
          
          <div className="p-4 border border-gray-200 rounded-lg">
            <div className="text-3xl text-primary-600 mb-2">💼</div>
            <h3 className="text-lg font-medium mb-2">Plus de clients</h3>
            <p className="text-gray-600">
              Accédez à un plus grand nombre de demandes juridiques et développez votre clientèle.
            </p>
          </div>
          
          <div className="p-4 border border-gray-200 rounded-lg">
            <div className="text-3xl text-primary-600 mb-2">🤖</div>
            <h3 className="text-lg font-medium mb-2">IA avancée</h3>
            <p className="text-gray-600">
              Utilisez notre assistant IA pour vous aider dans vos recherches juridiques et la rédaction de documents.
            </p>
          </div>
        </div>
      </div>
